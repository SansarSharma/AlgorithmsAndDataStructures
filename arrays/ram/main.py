...
Going back to our integers, each of [1, 3, 5] has a binary representation, meaning they can be represented as 0s and 1s.
If we use a single byte to store each, then the integer 1 can be represented as 00000001, 3 as 00000011, and 5 as 00000101.
...
Image: https://imagedelivery.net/CLfkmk9Wzy8_9HRyug4EVA/5b898b0a-b35f-40e1-32d2-60a3ef8b7c00/sharpen=1
...
Image: https://imagedelivery.net/CLfkmk9Wzy8_9HRyug4EVA/fbe06cc0-2bfb-4138-ad12-d4d0b67f9400/sharpen=1
Each character occupies 1 byte of space, hence the addresses are 1 byte apart.

The size or the type of data we store doesn't really matter, as long as the address is incremented relative to the size of the data type.
Most of the time this knowledge is abstracted away from us as developers, but it is relevant to understand many algorithms and data structures. It is also extremely important in system design.
